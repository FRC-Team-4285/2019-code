...
//  CANSparkMax Motor5 = new CANSparkMax(5, MotorType.kBrushless);//12in lift Forward/Backwards Motor
  ...
  public void autonomousPeriodic() {
    ...
    boolean Stepperout = stick.getRawButton(8);
    boolean Stepperin = stick.getRawButton(7);
    boolean PLANBout = stick.getRawButtonPressed(1);
    boolean PLANBin = stick.getRawButtonReleased(1);
    boolean PLANBHout = stick.getRawButtonPressed(4);
    boolean PLANBHin = stick.getRawButtonReleased(4);
...
*/
    ...
    if(stick.getRawAxis(2) < 0.1 && stick.getRawAxis(3) < .1){
